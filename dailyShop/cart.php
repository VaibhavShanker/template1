                    ...
                    <tbody>
                      ...
                      if($result5->num_rows>0) {
                        while($row5=$result5->fetch_assoc()) {
                           ...
                           <td><a href="#"><img src="img/women/'.$row5['image'].'" alt="img"></a></td>
                           <td><a class="aa-cart-title" href="#">'.$row5['name'].'</a></td>
                           <td>'.$row5['price'].'</td>
                           <td><input class="aa-cart-quantity" type="number" value="'.$row5['quantity'].'"></td>
                           <td>'.($row5['price']*$row5['quantity']).'</td>
                         </tr>';
                        }
                      }
