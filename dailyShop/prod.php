            ...
            <div class="aa-product-catg-body">
              <ul class="aa-product-catg">
                ...
                <?php
                    ...
                    $sql = "SELECT * form products DESC LIMIT {$offset},{$limit}";
                    $result =mysqli_query($conn, $sql) or die ("QF.");
...
<!-- 
                    ...
                    //     while($row= $result->fetch_assoc()) {
                        ...
                        //       <p class='aa-product-descrip'>".$row['long_description']."</p>
                        //     </figcaption>
                        //   </figure>                         
                  ...
                  <figure>
                    ...
                    <?php while($row = mysqli_fetch_assoc($result)) {?>
                      ...
                      <p class="aa-product-descrip"><?php echo $row['long_description'] ?></p>
                    <?php } ?>
                    </figcaption>
                  </figure>                         
                  <div class="aa-product-hvr-content">
