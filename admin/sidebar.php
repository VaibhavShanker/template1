<div id="sidebar">
   <div id="sidebar-wrapper">
      ...
      <?php
         ...
         'product.php','categories.php','tag.php');
    ...
    <!-- Logo (221px wide) -->
        ...
        <div id="profile-links">
                 ...
                 you have <a href="#messages" rel="modal" title="3 Messages">
                3 Messages</a><br />
                <br />
...
<a href="#" class="nav-top-item <?php if (in_array($filename, $productmenu)) : ?>current<?php endif; ?>">
            ...
            <ul>
               ...
               <li><a <?php if ($filename=='product.php') : ?>class="current"<?php endif;?> href="product.php">Manage Products</a></li>
               <!-- Add class "current" to sub menu items also -->
               <li><a <?php if ($filename=='categories.php') : ?>class="current"<?php endif;?> href="categories.php">Add Categories</a></li>
               <li><a <?php if ($filename=='tag.php') : ?>class="current"<?php endif;?> href="tag.php">Add Tags</a></li>
            </ul>
         </li>
        ...
        <li>
              <a href="#" class="nav-top-item"> Settings
              </a>
            <ul>
            ...
            <div id="messages" style="display: none"> 
                    <!-- Messages are shown when a link with these
                     attributes are clicked: href="#messages" rel="modal"  -->
                    ...
                    <h3>3 Messages</h3>
                        ...
                        <small>
                         <a href="#" class="remove-link" title="Remove message">
                         Remove</a></small>
                        </p>
