...
<input type="checkbox" name="checkbox4" /> Hand Bag
<input type="checkbox" name="checkbox3" /> Laptop
<input type="checkbox" name="checkbox4" /> Headphone
</p>
